/*
 @file     xmodem.h								@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
 @brief    Includes definitions needed for		@@@@@@@@@@@@@@@@##@@@@@@@@`%@@@@@@@@@@@@@@@@@@@@
		   XMODEM CRC 16 bit protocol			@@@@@@@@@@@@@@@@‾‾* `       ` *@@@@@@@@@@@@@@@@@
 @author   destrocore							@@@@@@@@@@@@@@#                   #@@@@@@@@@@@@@
 @version  V1.0									@@@@@@@@@@@@                        @@@@@@@@@@@@
												@@@@@@@@@@@          _ @@@@@@@\     ``\@@@@@@@@@
This file contains the common defines related to  @@@@@@@@%       %@@@@ ``*@@@@@@\_      \@@@@@@@@
XMODEM CRC 16 bit protocol:						@@@@@@@*      +@@@@@  /@@#  `*@@@@\_    \@@@@@@@
- states related to XMODEM state machine		@@@@@@/      /@@@@@   /@@  @@@@@@@@@|    !@@@@@@
- XMODEM bytes									@@@@/       /@@@@@@@%  *  /` ___*@@@|    |@@@@@@
												@@@#       /@@@@@@@@@       ###}@@@@|    |@@@@@@
												@@@@@|     |@@@@@@@@@      	  __*@@@      @@@@@@
												@@@@@*     |@@@@@@@@@        /@@@@@@@/     '@@@@
